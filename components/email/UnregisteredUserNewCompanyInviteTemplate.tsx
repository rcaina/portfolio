export default function UnregisteredUserNewCompanyInviteTemplate({
  name,
  companyName,
}: {
  name: string;
    ...
    <div style="background-color: #3A397E; padding: 80px; border-radius: 5px;">
      ...
      <div style="background-color: #f2f2f2; padding: 50px; border-radius: 5px;">
        <div style="text-align: left; font-family: Inter, sans-serif; line-height: 24px; font-weight: 500; font-size: 14px; color: #3A397E; border-bottom: 1px solid #F3F4F6;">
          ...
          <p>  
            You have been invited to join the ${companyName} team on Resonant!
          </p>
          <p>  
            You must first complete registration before you can access the team by signing up using the button below.
          </p>
          <p>  
            Once registered, you may switch between clinics by clicking on your account dropwdown menu on the bottom left corner of the screen and select the "Switch Clinic" option.
          </p>
          <p>
           - The Resonant Team
          </p>
