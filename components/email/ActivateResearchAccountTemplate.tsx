export default function ActivateResearchAccountTemplate({
  name,
  companyName,
  email,
}: {
  ...
  let link = "https://app.resonantdx.com/research/sign-up";
  if (email) {
    link = `https://app.resonantdx.com/research/sign-up?email=${encodeURIComponent(
      email
    )}`;
  }
  return `
    <div style="background-color: #3A397E; padding: 80px; border-radius: 5px;">
      ...
      <div style="background-color: #f2f2f2; padding: 50px; border-radius: 5px;">
        <div style="text-align: left; font-family: Inter, sans-serif; line-height: 24px; font-weight: 500; font-size: 14px; color: #3A397E; border-bottom: 1px solid #F3F4F6;">
          ...
          <p>  
            Congratulations! A Resonant account has successfully been created for you for company ${companyName}.
          </p>
          <p>  
            Please activate your account by clicking the button below and using this exact email.
          </p>
          <p>
           - The Resonant Team
          </p>
