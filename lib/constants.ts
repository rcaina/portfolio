...
export const EXPERIENCES = [
  {
    ...
    portal: "",
    description: [
      "Designed, built, and shipped joinbelle.com as the sole engineer, migrating a women's health telehealth marketing site from Webflow to Next.js 16 (App Router) and a Sanity headless CMS across 200+ commits, with 60+ permanent redirects to preserve SEO equity.",
      // "Built a comprehensive Schema.org JSON-LD and dynamic sitemap SEO layer for YMYL medical content, expanding the indexable surface from 3 pages to 30+.",
      // "Shipped a 'Find Your Treatment' quiz with a custom scoring and recommendation engine (category to symptoms to severity to ranked matches), plus a CMS-configurable, A/B-tested intake flow with full UTM and affiliate attribution forwarding.",
      "Designed a Sanity content model of 15+ schema types so non-technical staff manage all copy, pricing, and imagery without deploys, backed by a typed GROQ data layer with webhook-driven cache revalidation and ISR.",
      "Authored a token-based, mobile-first design system and built scroll-driven Framer Motion animations across 35+ components with full prefers-reduced-motion support.",
    ],
    technologies: [
      "Cloudflare",
      "TypeScript",
  ...
  },
  {
    ...
    integrations: ["Clerk", "Stripe", "AG-GRID"],
  ...
  },
  {
    ...
    integrations: ["Shopify", "Quickbooks", "CartRover", "POWER BI"],
    subsidiaries: [],
    color: "#000000",
  },
  {
    ...
    portal: "",
    description: [
      "Create mobile app (FitSnitch) for fitness trainers and trainees using React Native and TypeScript for UI design.",
    ...
    integrations: ["AWS Cognito", "Firebase Authentication", "Google Sign-In"],
    subsidiaries: [],
    color: "#FF0000",
  },
  {
  ...
  },
  {
    ...
    technologies: ["Linux", "Ansible", "vim"],
    subsidiaries: [],
  },
  {
